...
- **前端** ([frontend/](frontend/))：Vite 8.1.0 + TailwindCSS 4.3.1，工业控制台美学、WASD + 1-100 调速滑块、Web Worker 取流 + 延时显示、拍照加载圈、Web Serial 配网、PWA injectManifest 离线缓存
...
- **后端**：Rust stable、actix-http 3.13.1、rustls 0.23、DashMap、tokio broadcast、include_dir
- **前端**：Vite 8.1.0、TailwindCSS 4.3.1、React、Web Worker、Web Serial API、vite-plugin-pwa（injectManifest）
